  ...
  <div className="row g-4">
    ...
    <div className="col-12 col-md-8">
      <div className="d-flex flex-column gap-3">
        {[...Array(4)].map((_, i) => (
          <div key={i}>
            <SkeletonInput alto="14px" ancho="30%" />
        ...
        <div className="row g-3">
          <div className="col-7">
            <SkeletonInput alto="14px" ancho="40%" />
            <div style={{ marginTop: '6px' }}><SkeletonInput /></div>
          </div>
          <div className="col-5">
            <SkeletonInput alto="14px" ancho="40%" />
            <div style={{ marginTop: '6px' }}><SkeletonInput /></div>
        ...
        <div className="d-flex gap-2">
          {[...Array(5)].map((_, i) => (
            <SkeletonInput key={i} alto="36px" ancho="36px" />
          ))}
        </div>
        <div className="d-flex gap-3 mt-2">
          <SkeletonInput alto="44px" />
          <SkeletonInput alto="44px" />
        </div>
      </div>
    </div>
...
function EditarLibro() {
  ...
  // Previsualización en vivo al cambiar el ISBN
  useEffect(() => {
    if (isbn.trim()) {
  ...
  const handleSubmit = async () => {
    setEnviando(true)
    try {
      await actualizarLibro(id, { titulo, autor, isbn, genero, anio, rating })
              ...
              >
                {urlPortada && !portadaError ? (
                  ...
                  >
                    ...
                    >
                      La portada se actualizará al ingresar el ISBN
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="d-flex flex-column gap-3">
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--muted)', fontSize: '0.72rem', marginTop: '5px', marginBottom: 0 }}>
                    ...
                    Ingresa el ISBN para cargar la portada automáticamente.
                  </p>
                </div>
                ...
                <div className="row g-3">
                  <div className="col-7">
                    ...
                    <select
                      ...
                      style={{ ...estiloInput, backgroundColor: 'var(--surface2)' }}
                      onFocus={handleFocusInput}
                      onBlur={handleBlurInput}
                    >
                      <option value="" style={{ background: 'var(--surface2)', color: 'var(--muted)' }}>
                        Seleccionar...
                      </option>
                      {GENEROS.map(g => (
                        <option key={g} value={g} style={{ background: 'var(--surface2)', color: 'var(--text)' }}>
                          {g}
                        </option>
                      ))}
                    </select>
                ...
                <div>
                    ...
                    {[1, 2, 3, 4, 5].map(n => (
                      <span
                        ...
                        style={{
                          fontSize: '2rem',
                          cursor: 'pointer',
                          color: n <= (hoverRating || rating) ? 'var(--gold)' : 'var(--muted)',
                  ...
                  {rating > 0 && (
                    <p style={{ color: 'var(--muted)', fontSize: '0.78rem', marginTop: '4px', marginBottom: 0 }}>
