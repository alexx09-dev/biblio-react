...
// Skeleton del layout completo mientras carga
        ...
        {cargando ? (
          ...
          <div className="row g-5">
            ...
            <div className="col-12 col-md-4">
              ...
              {/* Metadatos debajo de la portada */}
                  ...
                  {libro.anio && (
                    <div className="d-flex align-items-center gap-2">
                      ...
                      <span style={{ color: 'var(--muted)', fontSize: '0.82rem' }}>
                        Año: <span style={{ color: 'var(--text)' }}>{libro.anio}</span>
                      </span>
                    </div>
                  )}
                  {libro.isbn && (
                    <div className="d-flex align-items-center gap-2">
                      <span style={{ fontSize: '0.9rem' }}>🌍</span>
                      <span style={{ color: 'var(--muted)', fontSize: '0.82rem' }}>
                        ISBN: <span style={{ color: 'var(--text)' }}>{libro.isbn}</span>
                      </span>
                    </div>
                  )}
                  {libro.genero && (
                    <div className="d-flex align-items-center gap-2">
                      <span style={{ fontSize: '0.9rem' }}>📚</span>
                      <span style={{ color: 'var(--muted)', fontSize: '0.82rem' }}>
                        Género: <span style={{ color: 'var(--text)' }}>{libro.genero}</span>
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="col-12 col-md-8">
              ...
              <div className="mb-4">
                ...
                <p style={{ color: 'var(--muted)', lineHeight: 1.8, fontSize: '0.95rem' }}>
                  {libro.sinopsis ||
                    'La sinopsis de este libro no está disponible aún.'}
                </p>
              </div>
